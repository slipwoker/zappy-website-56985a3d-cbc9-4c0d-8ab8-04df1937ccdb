    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Ad kitchen line משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '56985a3d-cbc9-4c0d-8ab8-04df1937ccdb',
                    name: data.name || '',
                    email: data.email || '',
